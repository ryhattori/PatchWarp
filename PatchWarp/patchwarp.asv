...
if run_affine_wc == 1
    ...
    patchwarp_affine(save_path_prewarp, save_path_postwarp, n_ch, align_ch, warp_template_tiffstack_num, warp_movave_tiffstack_num, warp_blocksize, warp_overlap_pix, n_split4warpinit, edge_remove_pix, affinematrix_abssum_threshold, affinematrix_rho_threshold, affinematrix_medfilt_tiffstack_num, downsample_frame_num);
else
